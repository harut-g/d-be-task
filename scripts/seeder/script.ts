import { Contract, Job, Profile, connectToDatabase } from "../../src/model";
import { ContractStatus } from "../../src/model/contract.model";
import { ProfileType } from "../../src/model/profile.model";

/* WARNING THIS WILL DROP THE CURRENT DATABASE */
export async function seedDB() {
  const sequelize = connectToDatabase({ log: false });
